...
import { registerAskBridge } from './ask-bridge.mjs'
...
export function apply(ctx, config = {}) {
  ...
  // ask_user_question 桥接：提问时推通知（human-call 提醒）。包装 ctx.userQuestions.ask，
  // 无该服务时静默跳过。
  disposers.push(registerAskBridge(ctx, notifier, { logger }))
